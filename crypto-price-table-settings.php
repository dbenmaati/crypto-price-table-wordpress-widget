...
add_action('admin_enqueue_scripts', 'enqueue_cptpref_crypto_price_table_styles');

function enqueue_cptpref_crypto_price_table_styles($hook) {
...
function cptpref_crypto_price_table_settings_page() {
    ?>
    <div class="wrap">
        ...
        <div class="cpt-crypto-settings-container">
            <div class="cpt-crypto-settings-box">
                ...
                <?php wp_editor(cptpref_generate_shortcode_preview(), 'editor1', ['wpautop' => 1, 'media_buttons' => 0, 'textarea_name' => '', 'textarea_rows' => 6, 'tabindex' => null, 'teeny' => 0, 'dfw' => 0, 'tinymce' => 0, 'quicktags' => 0, 'drag_drop_upload' => false]); ?>
            </div>
            <div class="cpt-crypto-preview-box">
                <h2><?php esc_html_e('Preview', 'crypto-price-table'); ?></h2>
                <?php echo do_shortcode(cptpref_generate_shortcode_preview()); ?>
            </div>
        </div>
    </div>
...
function cptpref_generate_shortcode_preview() {
...
function cptpref_crypto_price_table_register_settings() {
    register_setting('crypto_price_table_settings_group', 'crypto_price_table_coins', 'cptpref_crypto_price_table_sanitize_coins');
    ...
    add_settings_section(
        ...
        'cptpref_crypto_price_table_main_section_cb',
        'crypto_price_table'
    );
    ...
    add_settings_field(
        ...
        'cptpref_crypto_price_table_coins_field_cb',
        'crypto_price_table',
        'crypto_price_table_main_section'
    );
    ...
    add_settings_field(
        ...
        'cptpref_crypto_price_table_text_color_field_cb',
        'crypto_price_table',
        'crypto_price_table_main_section'
    );
    ...
    add_settings_field(
        ...
        'cptpref_crypto_price_table_table_head_color_field_cb',
        'crypto_price_table',
        'crypto_price_table_main_section'
    );
    ...
    add_settings_field(
        ...
        'cptpref_crypto_price_table_table_body_color_field_cb',
        'crypto_price_table',
        'crypto_price_table_main_section'
    );
    ...
    add_settings_field(
        ...
        'cptpref_crypto_price_table_marketcap_cb',
        'crypto_price_table',
        'crypto_price_table_main_section'
    );
    ...
    add_settings_field(
        ...
        'cptpref_crypto_price_table_credits_cb',
        'crypto_price_table',
        'crypto_price_table_main_section'
    );
}
...
function cptpref_crypto_price_table_main_section_cb() {
...
function cptpref_crypto_price_table_coins_field_cb() {
...
function cptpref_crypto_price_table_text_color_field_cb() {
...
function cptpref_crypto_price_table_table_head_color_field_cb() {
...
function cptpref_crypto_price_table_table_body_color_field_cb() {
...
function cptpref_crypto_price_table_marketcap_cb() {
...
function cptpref_crypto_price_table_credits_cb() {
...
function cptpref_crypto_price_table_sanitize_coins($input) {
    if (is_array($input)) {
        return $input;
    }
...
function cptpref_crypto_price_table_enqueue_scripts() {
...
add_action('admin_enqueue_scripts', 'cptpref_crypto_price_table_enqueue_scripts');

// Hook into admin init to register settings
add_action('admin_init', 'cptpref_crypto_price_table_register_settings');
?>
